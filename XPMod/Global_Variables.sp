...
//Timer Handles
new Handle:g_hTimer_FreezeCountdown 						= INVALID_HANDLE;
new Handle:g_hTimer_DrugPlayer[MAXPLAYERS + 1] 				= INVALID_HANDLE;
new Handle:g_hTimer_HallucinatePlayer[MAXPLAYERS + 1]		= INVALID_HANDLE;
new Handle:g_hTimer_SlapPlayer[MAXPLAYERS + 1] 				= INVALID_HANDLE;
new Handle:g_hTimer_RochellePoison[MAXPLAYERS + 1] 			= INVALID_HANDLE;
new Handle:g_hTimer_HunterPoison[MAXPLAYERS + 1] 			= INVALID_HANDLE;
...
new Handle:g_hTimer_BlockGooSwitching[MAXPLAYERS + 1] 		= INVALID_HANDLE;

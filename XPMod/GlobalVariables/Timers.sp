//Timer Handles
Handle g_hTimer_ResetHideNameChangeMessage 				        = null;
Handle g_hTimer_FreezeCountdown 						        = null;
Handle g_hTimer_ShowingConfirmTalents[MAXPLAYERS + 1]	        = {null, ...};
Handle g_hTimer_ExtinguishTank[MAXPLAYERS + 1]		            = {null, ...};
Handle g_hTimer_VictimHealthMeterStop[MAXPLAYERS + 1]	        = {null, ...};
Handle g_hTimer_SelfReviveCheck[MAXPLAYERS + 1]	                = {null, ...};
Handle g_hTimer_DrugPlayer[MAXPLAYERS + 1] 				        = {null, ...};
Handle g_hTimer_HallucinatePlayer[MAXPLAYERS + 1]		        = {null, ...};
Handle g_hTimer_SlapPlayer[MAXPLAYERS + 1] 				        = {null, ...};
Handle g_hTimer_RochellePoison[MAXPLAYERS + 1] 			        = {null, ...};
Handle g_hTimer_HunterPoison[MAXPLAYERS + 1] 			        = {null, ...};
Handle g_hTimer_HunterImmobilityZone[MAXPLAYERS + 1] 			= {null, ...};
...
Handle g_hTimer_ZoeySacrificialAidBleedoutCheck[MAXPLAYERS + 1] = {null, ...};

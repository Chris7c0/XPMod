...
// This is not a great way to do this, do it in the user customizable files later
...
#define DAMAGETYPE_MOUNTED_MACHINE_GUN	    -2130706430
...
bool g_bAFKIdleKickingEnabled;
#define AFK_IDLE_PLAYER_KICK_WARNING_START_TIME     90
#define AFK_IDLE_PLAYER_KICK_TIME                   300
...
// DPS Meter
#define DPS_METER_TIME_UNTIL_RESET          3.0     // Time from last attack the next when the DPS Meter is reset

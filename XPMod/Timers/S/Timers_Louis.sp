Action LouisTeleportReenable(Handle timer, int iClient)
{
	g_bLouisTeleportCoolingDown[iClient] = false;
	return Plugin_Stop;
}

Action LouisLaserModeToggleReenable(Handle timer, int iClient)
{
	g_bLouisLaserModeToggleCooldown[iClient] = false;
	return Plugin_Stop;
}

Action TimerSetLouisTeleportInactive(Handle timer, int iClient)
{
...
Action TimerLouisTeleportChargeRegenerate(Handle timer, int iClient)
{
...
Action TimerLouisTeleportChargeResetAll(Handle timer, int iClient)
{
...
Action TimerLouisTeleportRemoveMovementSpeedPenalty(Handle timer, int iClient)
{
...
Action TimerLouisCIHeadshotReduce(Handle timer, int iClient)
{
...
Action TimerLouisSIHeadshotReduce(Handle timer, int iClient)
{
...
Action TimerLouisPillsUsedStackReduce(Handle timer, int iClient)
{
...
Action TimerReEnableNoobWipe(Handle timer, int iClient) {

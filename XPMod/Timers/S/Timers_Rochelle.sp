...
Action Timer_RochelleRugerHitCheck(Handle timer, int iClient)
{
...
Action Timer_RochelleAWPResetChargeLevel(Handle timer, int iClient)
{
...
Action Timer_BreakFreeOfSmoker(Handle timer, int iClient)
{
...
Action TimerStopShadowNinja(Handle timer, int iClient)
{
...
Action TimerPoison(Handle timer, int iClient)
{
...
Action TimerPoisonFade(Handle timer, int iClient)
{
...
Action TimerIDD(Handle timer, int data)
{

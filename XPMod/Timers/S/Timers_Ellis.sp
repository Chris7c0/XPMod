Action TimerStopFireStorm(Handle timer, int iClient)
{
...
Action TimerEllisPrimaryCycleReset(Handle timer, int iClient)
{
...
Action TimerRemoveEllisAdrenalineBuffs(Handle timer, int iClient)
{
...
Action TimerEllisLimitBreakReset(Handle timer, int iClient)
{
...
Action TimerEllisLimitBreakCooldown(Handle timer, int iClient)
{

...
void ResetClientVariablesForRound(int iClient)
{
	...
	g_iStat_ClientDamageTakenSurvivor[iClient] = 0;
	g_iStat_ClientDamageTakenInfected[iClient] = 0;
	g_iStat_ClientFriendlyFireDamage[iClient] = 0;
	g_iStat_ClientDamageSmoker[iClient] = 0;
	g_iStat_ClientDamageBoomer[iClient] = 0;
	g_iStat_ClientDamageHunter[iClient] = 0;
	g_iStat_ClientDamageSpitter[iClient] = 0;
	g_iStat_ClientDamageJockey[iClient] = 0;
	g_iStat_ClientDamageCharger[iClient] = 0;
	g_iStat_ClientDamageTank[iClient] = 0;
	g_iSurvivorPickRecordID[iClient] = -1;
...
void DeleteAllGlobalTimerHandles(int iClient)
{
	...
	delete g_hTimer_IceTankColdSlowAuraEnableAgain[iClient];

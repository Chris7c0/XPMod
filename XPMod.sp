...
SetupGameOffsets()
{
	...
	g_iOffset_HealthBuffer			= FindSendPropOffs("CTerrorPlayer", "m_healthBuffer");
	g_iOffset_HealthBufferTime		= FindSendPropOffs("CTerrorPlayer", "m_healthBufferTime");
	...
	g_iOffset_MoveCollide 			= FindSendPropOffs("CBaseEntity", "movecollide");
	g_iOffset_MoveType    			= FindSendPropOffs("CBaseEntity", "movetype");
	g_iOffset_VecVelocity   		= FindSendPropOffs("CBasePlayer", "m_vecVelocity[0]");
	g_iOffset_IsGhost       		= FindSendPropInfo("CTerrorPlayer", "m_isGhost");
	//g_iOffset_OwnerEntity			= FindSendPropOffs("CBaseCombatWeapon", "m_hOwnerEntity");
